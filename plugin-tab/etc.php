...
if ( ! function_exists ( 'oxsn_hover_box_plugin_nav_item' ) ) {

	add_action('admin_menu', 'oxsn_hover_box_plugin_nav_item', 99);
	function oxsn_hover_box_plugin_nav_item() {

		add_submenu_page('oxsn-dashboard', 'OXSN Hover Box', 'Hover Box', 'manage_options', 'oxsn-hover-box', 'oxsn_hover_box_plugin');

	}

}

if ( !function_exists('oxsn_hover_box_plugin') ) {

	function oxsn_hover_box_plugin() {
					...
					<div class="oxsn_xs_float_left oxsn_xs_width_100pr oxsn_sm_width_40pr oxsn_xs_padding_left_0px oxsn_sm_padding_left_10px">
						...
						<div class="postbox">
							...
							<div class="inside">
								...
								<p><a href="https://wordpress.org/support/plugin/oxsn-hover-box" target="_blank" class="button button-primary button-large">Support</a></p>
